...
class SpatialRegionMerger:
    ...
    def merge_regions(cls, raw_regions: list, iou_thresh: float = 0.16, max_dist: int = 14, **kwargs) -> list:
        ...
        while sorted_zones:
            ...
            # Accept if it is a confirmed thick markup stroke, an ELA cluster, or multi-verified
            if not (has_digital_markup or has_strong_ela or has_photo_swap or is_multi_confirmed):
